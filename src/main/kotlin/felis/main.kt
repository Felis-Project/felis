...
fun main(args: Array<String>) {
    ...
    FelisLaunchEnvironment.let { env ->
        ...
        env.logger.info("Felis environment: mods=${env.mods}, side=${env.side}, launcher=${env.launcher}, print-cp=${env.printClassPath}, print-res=${env.printResolutionStages}, audit=${env.audit}")
